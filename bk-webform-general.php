...
<div class="c-form-header">
  ...
  <div class="c-form-header__container o-wrapper">
...
<div class="c-page-quote">
  <div class="c-page-quote__container o-wrapper o-wrapper--large"> 
    <div class="c-page-quote__steps c-page-quote-steps">
      <div class="c-page-quote-steps__step c-page-quote-steps__step_current">
        <div class="c-page-quote-steps__icon">1</div>
        <div class="c-page-quote-steps__text">Personal <br/> Information</div>
      </div>
    ...
    <input type="hidden" name="type_insurance" value="{type_insurance}">                     
      ...
      <div class="c-page-quote-form__item">
        ...
        <input class="c-page-quote-form__input js-valid-zipcode js-only-numbers" value="{zipcode}" id="form-zipcode" type="tel" name="lead[zipcode]" maxlength="5" data-validate-field="zipcode" required="required"/>
      </div>
      <div class="c-page-quote-form__item">
